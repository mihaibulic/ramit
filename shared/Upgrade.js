...
Upgrade.prototype.load = function() {
  ...
  this.diff[d.PROJECTILE][t.COOLDOWN] = [ -75, -75, -75 ];
  ...
  this.diff[d.ROCKET][t.COOLDOWN] = [ -1000 ];
  ...
  this.diff[d.EMP][t.COOLDOWN] = [ -1000 ];
  ...
  this.diff[d.MEDIC][t.COOLDOWN] = [ -2000 ];
  ...
  this.diff[d.SHIELD][t.COOLDOWN] = [ -2000 ];
